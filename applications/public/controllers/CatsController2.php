...
class CatsController2 extends Controller {
    ...
    public function godfathered()
    {
        ...
        $this->views->display('novo/godfathered_cats.phtml');
    }
    ...
    public function godfathered_form()
    {
        ...
        $this->views->display('novo/godfathered_form.phtml');
    }
    ...
    public function godfathered_success()
    {
        ...
        $this->views->display("novo/godfathered_success.phtml");
    }
    ...
    public function details()
    {
        ...
        $this->views->display("novo/cat_detail.phtml");
    }
    ...
    public function form()
    {
        ...
        $this->views->display('novo/adoption_form.phtml');
    }
    ...
    public function success_page()
    {
        ...
        $this->views = new Views($template);
        $this->views->display("novo/adoption_success.phtml");
    }

    public function error_page()
    {
        $this->views = new Views(new Template("public", "novo/default.phtml"));
        $this->views->display("novo/adoption_error.phtml");
    }
}