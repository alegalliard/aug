<?php
    ...
    ///////////
        ...
        'gato-busca(?P<search_query>.*)'  => 'public.SearchController.cats_search',
        ...
        /* páginas novas */
        'preparado-para-adotar'		=> 'public.IndexController.ready',
        'politica-de-adocao-aug'		=> 'public.IndexController.policy',
        'como-adotar-um-gatinho'		=> 'public.IndexController.how',
        'um-ou-dois-gatinhos'		=> 'public.IndexController.one_two',
        'felv'		=> 'public.IndexController.felv',
        'fiv'		=> 'public.IndexController.fiv',
        'pif'		=> 'public.IndexController.pif',
        'sobre'		=> 'public.IndexController.about',
        'quero-ajudar-a-aug'		=> 'public.IndexController.help',
        'resgate'		=> 'public.IndexController.rescue',
        'mitos-verdades-gatos-ferais' => 'public.IndexController.mitos',
        'mamadeiras' => 'public.IndexController.mamadeiras',
        'esporotricose' => 'public.IndexController.esporotricose'
    ...
    Phalanx::urlPatterns(
        ...
        'adm/paginas/estaticas'			    	=> 'admin.PagesController.statics',
        ...
        'adm/paginas/desativar/(?P<page_id>\d+?)'  => 'admin.PagesController.desativar'
        )
    );
    ...
    Phalanx::urlPatterns(
        array(
        'adm/padrinhos/all'					    	=> 'admin.TheGodfatherController.show',
        'adm/padrinhos/all/(?P<page>\d+?)'                    	=> 'admin.TheGodfatherController.show',
...
//        '(?P<page_slug>.*)?version=2' => 'public.PagesController2.display_page'
