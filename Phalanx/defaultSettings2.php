...
if(!defined('ROOT')) define('ROOT',$_SERVER['DOCUMENT_ROOT']) . '__novo/php/';
...
if(!defined('TEMPLATE_DIR')) define('TEMPLATE_DIR',ROOT.SEPD.PROJECT_DIR.SEPD.'template'.SEPD);

if(!defined('TEMPLATE')) define('TEMPLATE','default');


if(!defined('TEMPLATE_FILE')) define('TEMPLATE_FILE','novo/default.phtml');
...
if(!defined('EXTENSIONS_DIR')) define('EXTENSIONS_DIR',ROOT.'extensions'.SEPD);

if(!defined('URI')) define('URI',str_replace(SEPU.PROJECT_DIR.SEPU,'',$_SERVER['REQUEST_URI']));
...
if(!defined('UPLOAD_DIR')) define('UPLOAD_DIR', str_replace('/', SEPW, ROOT.PROJECT_DIR.'media'.SEPD.'uploads'.SEPD)); #Server folder to host the uploadedfiles
